...
export function Inventory() {
  const items: IInventoryItems = [
    { badgeColor: 'success', label: 'Tasks Pending' },
    { badgeColor: 'warning', label: 'Applications In Review' },
    { badgeColor: 'destructive', label: 'Customers Onboarded' },
  ];

  const rows: IInventoryRows = [
    { text: 'Workflow Task: Document Verification', total: 12, stats: '2.1', increase: true },
    { text: 'Application: New Account', total: 7, stats: '1.3', increase: false },
    { text: 'Customer: John Doe', total: 1, stats: '0.5', increase: true },
  ];
