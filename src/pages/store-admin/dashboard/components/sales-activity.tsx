...
export function SalesActivity() {
  const items: ISalesActivityItems = [
    { totalColor: 'text-primary', total: '8', label: 'Tasks', description: 'to be approved', icon: CheckCircle },
    { totalColor: 'text-destructive', total: '5', label: 'Applications', description: 'awaiting review', icon: FileText },
    { totalColor: 'text-green-500', total: '3', label: 'Customers', description: 'pending verification', icon: PackageCheck },
    { totalColor: 'text-yellow-400', total: '12', label: 'Tasks', description: 'completed today', icon: Truck },
  ];
