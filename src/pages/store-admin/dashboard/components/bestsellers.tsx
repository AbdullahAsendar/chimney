...
export function Bestsellers() {
  const items: IInventoryItems = [
    { product: '', name: 'John Doe', sku: 'Customer ID: 1001' },
    { product: '', name: 'Jane Smith', sku: 'Customer ID: 1002' },
    { product: '', name: 'Acme Corp Application', sku: 'App ID: 2001' },
    { product: '', name: 'Workflow Task: Review', sku: 'Task ID: 3001' },
  ];
